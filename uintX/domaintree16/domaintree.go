...
func (n *Node) Insert(d string, v uint16) *Node {
	if n == nil {
		n = &Node{}
	} else {
		n = &Node{
...
func (n *Node) InplaceInsert(d string, v uint16) {
	if n.branches == nil {
...
func (n *Node) Get(d string) (uint16, bool) {
	if n == nil {
		return 0, false
	}
...
func (n *Node) WireGet(d domain.WireNameLower) (uint16, bool, error) {
	if n == nil {
		return 0, false, nil
	}
